...
export default class Dapp extends React.Component<Props, State> {
  ...
  {
    return `https://${this.state.network?.chainId === 1 || !this.state.network?.name ? '' : this.state.network.name}mumbai.polygonscan.com/address/${CollectionConfig.contractAddress}`;
  }
